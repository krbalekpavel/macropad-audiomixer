...
namespace macropad_audiomixer
{
    ...
    /// </summary>
    public partial class ButtonPresetAdd : Window
    {
        public string PassedString { get; set; }
        public ButtonPresetAdd()
        {
            InitializeComponent();
        }
        ...
        {
            //string key = "ButtonPresets";
            //string[] presets = ReadSettingA("ButtonPresets").Split(',');
            //bool aight = true;
            ...
            if (aight == true)
            {
                string value = ReadSettingA("ButtonPresets") + "," + PresetNameBox.Text;
                try
                {
